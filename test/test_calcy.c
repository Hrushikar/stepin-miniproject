...
void dividede(void){
    ...
    TEST_ASSERT_EQUAL(UNDERFLOW, res);
    // TEST_ASSERT_LESS_OR_EQUAL(-41.989165, res);
    // TEST_ASSERT_GREATER_THAN(-42.0, res);
    ...
    TEST_ASSERT_EQUAL(OVERFLOW, res);
    // TEST_ASSERT_GREATER_THAN(-42.0, res);
...
void solveQuad(void){
    ...
    TEST_ASSERT_EQUAL(UNDERFLOW, res1);
    TEST_ASSERT_EQUAL(UNDERFLOW, res2);
...
void matAdd(void){
    ...
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[0][0]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[0][1]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[0][2]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[1][0]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[1][1]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[1][2]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[2][0]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[2][1]);
    TEST_ASSERT_EQUAL(UNDERFLOW, res_mat[2][2]);
